...
export const ConfiguracionItemMedidas = ({ id, nombre}) => {
    ...
    const eliminarDocumento = ()=>{
        dispatch( eliminarDocumentoFirebase(`/aplicaciones/productos/medidas/${id}`, id));
    }
  return (
    <>
        ...
        mensaje={`Estas a punto de eliminar el tipo de medida ${nombre.toUpperCase()} ¿Deseas continuar?`}
