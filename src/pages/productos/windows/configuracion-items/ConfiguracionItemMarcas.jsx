...
export const ConfiguracionItemMarcas = ({ id, nombre, procedencia }) => {
    ...
    const eliminarDocumento = ()=>{
        dispatch( eliminarDocumentoFirebase(`/aplicaciones/productos/marcas/${id}`, id));
    }
  return (
    ...
    <>
        ...
        mensaje={`Estas a punto de eliminar la marca ${nombre.toUpperCase()} ¿Deseas continuar?`}
        ...
        <li className='list-group-item d-flex align-items-center' >
            ...
            <div className="d-flex flex-column" >
                <span>{nombre.toUpperCase()} - {procedencia.toUpperCase()}</span>   
            </div>
            <button 
