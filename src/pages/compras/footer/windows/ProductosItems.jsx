...
export const ProductosItems = ({productosItems, setProductosItems, listItems, listDelete, setListItems, listAdd}) => {
    ...
    const agregarItem = (codigo) => {
        ...
        const {nombre, marca, modelo, cantidad, id} = itemSelect;
        setListItems(newList);
        listAdd({nombre, marca, modelo, cantidad, cantidadResivida:'', id, precio:'' });
