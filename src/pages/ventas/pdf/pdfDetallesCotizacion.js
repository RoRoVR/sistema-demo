...
export const pdfDetallesCotizacion = ( items, datos ) => {
    if( items ){
      ...
      for (let i = 0; i < newItems.length; i++) {
        ...
        doc.text( `COTIZACION Nº ${ datos.numero }`, 4.9, 0.5 );
        ...
        doc.setFont("QuicksandSemibold");
        doc.text( 'Cel: ', 0.6, 1.3);
        doc.setFont("QuicksandRegular");
        doc.text( `${ datos.cel }`, 1.3, 1.3 );
        doc.setFont("QuicksandSemibold");
        // -------------------- FIN ENCABEZADO --------------------
        ...
        autoTable(doc, {
          ...
          head: [['Nº', 'MODELO', 'MARCA', 'NOMBRE', 'CANT', 'P/UNIT', 'TOTAL']],
          body: newItems[i],
        ...
        doc.setFont("QuicksandRegular");
        doc.text( 'Av. Direccion Nº125', 3, footPageY + 0.5 );
        doc.setFont("QuicksandSemibold");
      ...
      doc.save(`COTIZACION Nº ${ datos.numero }.pdf`);
